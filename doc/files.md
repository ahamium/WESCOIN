...
* wescoin.conf: contains configuration settings for wescoind or wescoin-qt
* wescoind.pid: stores the process id of wescoind while running
...
* debug.log: contains debug information and general logging generated by wescoind or wescoin-qt
