...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use WESC/kB (MarcoFalke)
...
- #7692 `29b2be6` Remove P2P alert system (wescdrak)
...
- #8275 `042c323` Remove bad chain alert partition check (wescdrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (wescdrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (wescdrak)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (wescdrak)
...
- #7773 `7c80e72` Fix comments in tests (wescdrak)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (wescdrak)
