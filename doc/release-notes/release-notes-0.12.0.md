...
- #7209 `f3ad812` test: don't override WESCOIND and WESCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add WESCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "WESC" (Ross Nicoll)
