...
This document provides guidelines for internationalization of the Wescoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wescoin_en.ts` remains unchanged.
