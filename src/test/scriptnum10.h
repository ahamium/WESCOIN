...
#ifndef WESCOIN_TEST_SCRIPTNUM10_H
#define WESCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Wescoin Core 0.10.0, for cross-comparison.
 */
public:
