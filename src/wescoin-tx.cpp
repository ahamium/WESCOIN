...
static void SetupWescoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " wescoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  wescoin-tx [options] <hex-tx> [commands]  Update hex-encoded wescoin transaction\n" +
            "or:     wescoin-tx [options] -create [commands]   Create hex-encoded wescoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wescoin transaction
