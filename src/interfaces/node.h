...
#ifndef WESCOIN_INTERFACES_NODE_H
#define WESCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a wescoin node (wescoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // WESCOIN_INTERFACES_NODE_H
