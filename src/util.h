 ...
 */
#ifndef WESCOIN_UTIL_H
#define WESCOIN_UTIL_H
...
extern const char * const WESCOIN_CONF_FILENAME;
extern const char * const WESCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("wescoin-%s", name);
