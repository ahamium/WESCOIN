    ...
    mapper(0)
{
    ...
    ui->wescoinAtStartup->setToolTip(ui->wescoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->wescoinAtStartup->setText(ui->wescoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openWescoinConfButton->setToolTip(ui->openWescoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new WescoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->wescoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openWescoinConfButton_clicked()
{
