...
#ifndef WESCOIN_QT_WESCOINUNITS_H
#define WESCOIN_QT_WESCOINUNITS_H
...
/** Wescoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WescoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WescoinUnits(QObject *parent);

    /** Wescoin units.
      @note Source: https://en.wescoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WESC,
...
typedef WescoinUnits::Unit WescoinUnit;

#endif // WESCOIN_QT_WESCOINUNITS_H
