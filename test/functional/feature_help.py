...
"""Verify that starting wescoin with -h works as expected."""

from test_framework.test_framework import WescoinTestFramework
from test_framework.util import assert_equal

class HelpTest(WescoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wescoin with -h for help text")
        ...
        self.log.info("Start wescoin with -version for version information")
        ...
        self.log.info("Start wescoind with -fakearg to make sure it does not start")
