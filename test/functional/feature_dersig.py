...
class BIP66Test(WescoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # wescoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and wescoind produces more specific reject
            # reasons.
