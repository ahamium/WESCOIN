...
# TestP2PConn: A peer we use to send messages to wescoind, and store responses.
...
class CompactBlocksTest(WescoinTestFramework):
    ...
    # This test actually causes wescoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that wescoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for wescoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # wescoind will not send blocktxn responses for blocks whose height is
