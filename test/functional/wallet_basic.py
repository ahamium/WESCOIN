...
class WalletTest(WescoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 WESC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 wesc in block rewards plus fees, but
        ...
        # Send 10 WESC with subtract fee from amount
        ...
        # Sendmany 10 WESC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/wescoin/wescoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
